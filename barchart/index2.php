...
<body>
<a href='#' onclick='getData()'>getData()</a> - <a href='#' onclick='update()'>update()</a> - <a href='#' onclick='refresh()'>refresh()</a>
<br />

<input type='text' id='n1' value='40'>n1<br />
<input type='text' id='p1' value='0.3'>p1<br />
<input type='text' id='n2' value='40'>n2<br />
<input type='text' id='p2' value='0.7'>p2<br />
